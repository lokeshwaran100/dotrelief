...
export const DOTRELIEF_CONTRACT_ADDRESS = "0xb0F9338356425FE2ddB3b856239EB2b4a396C1f4";

// DotRelief Contract ABI
export const DOTRELIEF_ABI = [
  {
    "inputs": [],
  ...
  },
  {
    ...
    "outputs": [
      ...
      {
        "internalType": "enum DotRelief.ProposalType",
        "name": "proposalType",
        "type": "uint8"
      }
    ],
